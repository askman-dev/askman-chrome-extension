...
import { ChatPopupContext } from '@src/chat/chat';
import { ToolDropdown, QuoteDropdown, SystemPromptDropdown, ModelSelector } from '@src/components/features/controls';
import { tools } from '@src/components/features/controls/ToolDropdown';
import TextareaAutosize from 'react-textarea-autosize';
import { ArrowsPointingInIcon, ArrowsPointingOutIcon, XMarkIcon, PlusIcon } from '@heroicons/react/20/solid';
import { MessageItem } from '@src/components/features/message';
import {
...
export const AskPanel = DialogPanel;
